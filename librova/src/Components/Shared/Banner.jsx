...
const Banner = () => {
    return (
        <div className='bg-[#FFFFFF] max-w-135 md:max-w-3xl mx-5 md:mx-auto lg:max-w-6xl rounded-xl'>
            <div className='flex flex-col justify-center items-center py-20 lg:py-25 space-y-4'>
